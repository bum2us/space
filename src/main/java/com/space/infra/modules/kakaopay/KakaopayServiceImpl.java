...
public class KakaopayServiceImpl {
	...
	//카카오페이
		...
		public Kakaopay payReady(int userSeq, int charge) throws Exception {
			...
			params.add("approval_url", "http://localhost:8081/kakaopay/approval");
			params.add("cancel_url", "http://localhost:8081/kakaopay/cancel");
			params.add("fail_url", "http://localhost:8081/kakaopay/fail");
